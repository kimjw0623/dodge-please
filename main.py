...
print(len(summoners_id_list))

#summoners_id_list = summoners_id_list[0:1]
...
for summoners_id in summoners_id_list:
    ...
    for tag in soup.find_all('li',class_='css-ja2wlz e19epo2o3'):
        ...
        participants = tag.find_all('li', class_='css-tegtkt e19epo2o1')#[0].find_next_siblings('li')
        #game_ = participants[0]
